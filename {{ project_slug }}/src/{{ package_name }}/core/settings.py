...
class Settings:
    ...
    @classmethod
    def get_instance(cls, env_file: Optional[str | Path] = None, **kwargs) -> "Settings":
        """Get or create settings instance."""
        logger.debug(f"get_instance called with kwargs: {kwargs}")
        logger.debug(f"Current _instance: {cls._instance}")
    ...
    def _initialize(self, env_file: Optional[str | Path] = None, **kwargs):
...
def get_settings(env_file: Optional[str | Path] = None, **kwargs) -> Settings:
    ...
    Example:
        ...
        >>> settings = get_settings(database_url='custom://url')
        >>> print(settings.database_url)
        custom://url
    """
